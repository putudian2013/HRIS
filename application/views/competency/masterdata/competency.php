...
<html>
    <head>
        ...
        <title>Master Data Competency | HRIS</title>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                        ...
                                        <tbody> 
                                            ...
                                            ?>                                                                                                
                                                    <tr>
                                                        ...
                                                        <td width="10%">                                                   
                                                            <a href="<?php echo base_url('competency/edit/') . $row->competency_id; ?>" title="Edit" class="btn btn-success"> <i class="fa fa-pencil"></i> </a>
                                                            <a data-id="<?= $row->competency_id; ?>" title="Delete" class="btn btn-danger btn-delete"> <i class="fa fa-times"></i> </a>
                                                        </td>
                                                    </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                ...
                                <div class="box-footer">                                                                        
                                    <a href="<?php echo base_url('competency/add')?>" class="btn btn-primary pull-right"> <i class="fa fa-plus"></i> Add New Competency</a>
                                </div>                                 
                            </div>                            
                        </div>
                    </div>                    
                        ...
                        if (result.value) {
                            ...
                            $.ajax({
                                ...
                                success: function(data){
                                    ...
                                    //swal('Competency Deleted','Deleted Data Cannot Be Restored','success');
                                    swal({
