                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box">
                                ...
                                ?>
                                <form action="<?php echo base_url('competency/').$formAction?>" method="post">
                                    <div class="box-body">
                                        <?php 
                                            $competencyName = "";
                                            $competencyID = "";
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="competencyName" id="competencyName" placeholder="Example : Managemen Karyawan" required value="<?php echo $competencyName ?>">
                                        </div>                                        
                                        <div class="form-group">                                            
                                            <input type="hidden" class="form-control" name="competencyID" id="competencyID" value="<?php echo $competencyID ?>">
                                        </div>
                                    </div>                                                                
                                    <div class="box-footer">                                                                                                            
                                        <button type="submit" class="btn btn-primary pull-right"><?= ucwords($formAction) ?></button>
                                        <a href="<?php echo base_url('competency')?>" class="btn btn-default"> Cancel</a>
                                    </div> 
                                </form>
                            </div>                            
                        </div>
