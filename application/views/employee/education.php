...
<html>
    <head>
        ...
        <title>Employee Education | HRIS</title>
        ...
        <!-- Google Font -->
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?education=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">                
    </head>    
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                        ...
                                        <tbody> 
                                            ...
                                            ?>                                                                                                
                                                    <tr>
                                                        ...
                                                        <td width="10%">                                                   
                                                            <a href="<?php echo base_url('employeeEducation/edit/') . $row->emp_education_id . '/' . $employeeID . '/' . $companyID . '/' . $divisionID  . '/' . $departmentID ; ?>" title="Edit" class="btn btn-success"> <i class="fa fa-pencil"></i> </a>
                                                            <a data-id="<?= $row->emp_education_id; ?>" title="Delete" class="btn btn-danger btn-delete"> <i class="fa fa-times"></i> </a>
                                                        </td>
                                                    </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                ...
                                <div class="box-footer"> 
                                    ...
                                    <a href="<?= base_url('employeeEducation/add/' . $employeeID . '/' . $companyID . '/' . $divisionID  . '/' . $departmentID) ?>" class="btn btn-primary pull-right"> <i class="fa fa-plus"></i> Add New Employee Education</a>
                                </div>                                 
                            </div>                            
                        </div>
                    </div>                    
                ...
                $('.btn-delete').click(function(){
                    ...
                    swal({
                        ...
                        if (result.value) {
                            ...
                            $.ajax({
                                url : "<?php echo base_url(); ?>employeeEducation/delete/" + id,                        
                                method : "GET",                                                                                
