                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box">
                                ...
                                ?>
                                <form action="<?php echo base_url('section/').$formAction?>" method="post">
                                    <div class="box-body">
                                        <?php 
                                            $sectionName = "";
                                            $sectionID = "";
                                        ...
                                        <div class="form-group" style="width: 100%;">
                                            ...
                                            <select class="form-control select2"  id="departmentID" name="departmentID" required>
                                                <option value="">Select...</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="sectionName" id="sectionName" placeholder="Example : HRD" required value="<?php echo $sectionName ?>">
                                        </div>
                                        <div class="form-group">                                            
                ...
                $('#companyID').change(function(){
                    ...
                    $.ajax({
                        ...
                        success: function(data){                            
                            ...
                            $('#departmentID').html('<option value="0">Select...</option>');
                        }
                    });
                });
            });
